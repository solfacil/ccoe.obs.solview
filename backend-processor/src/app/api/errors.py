...
async def simulate_bad_request() -> Dict[str, Any]:
    ...
    logger.warning(
        "Backend: Simulating 400 Bad Request error",
...
async def simulate_unauthorized() -> Dict[str, Any]:
    ...
    logger.warning(
        "Backend: Simulating 401 Unauthorized error",
...
async def simulate_forbidden() -> Dict[str, Any]:
    ...
    logger.warning(
        "Backend: Simulating 403 Forbidden error",
...
async def simulate_not_found() -> Dict[str, Any]:
    ...
    logger.warning(
        "Backend: Simulating 404 Not Found error",
...
async def simulate_validation_error() -> Dict[str, Any]:
    ...
    logger.warning(
        "Backend: Simulating 422 Validation error",
...
async def simulate_rate_limit() -> Dict[str, Any]:
    ...
    logger.warning(
        "Backend: Simulating 429 Rate Limit error",
...
async def simulate_internal_error() -> Dict[str, Any]:
    ...
    logger.error(
        "Backend: Simulating 500 Internal Server Error",
...
async def simulate_bad_gateway() -> Dict[str, Any]:
    ...
    logger.error(
        "Backend: Simulating 502 Bad Gateway error",
...
async def simulate_service_unavailable() -> Dict[str, Any]:
    ...
    logger.error(
        "Backend: Simulating 503 Service Unavailable error",
...
async def simulate_gateway_timeout() -> Dict[str, Any]:
    ...
    logger.error(
        "Backend: Simulating 504 Gateway Timeout error",
...
async def simulate_random_error() -> Dict[str, Any]:
    ...
    logger.warning(
        f"Backend: Simulating random error: {status_code}",
...
async def simulate_slow_endpoint() -> Dict[str, Any]:
    ...
    logger.info(
        f"Backend: Simulating slow endpoint with {delay:.2f}s delay",
        delay_seconds=delay,
        service="backend-processor",
    ...
    if random.random() < 0.2:
        logger.error(
            "Backend: Slow endpoint timed out",
            error_type="timeout",
            service="backend-processor",
            event="error_simulation",
        )
    ...
    chaos_scenarios = [
        ...
        (
            ...
            lambda: HTTPException(
                status_code=500, detail="Backend: Chaos - Internal Error"
            ),
        ),
        (
            0.5,
            lambda: HTTPException(
                status_code=503, detail="Backend: Chaos - Service Unavailable"
            ),
        ),
        (
            0.6,
            lambda: HTTPException(
                status_code=429, detail="Backend: Chaos - Rate Limited"
            ),
        ),
        (
            0.7,
            lambda: HTTPException(
                status_code=502, detail="Backend: Chaos - Bad Gateway"
            ),
        ),
    ]
    ...
    for threshold, action in chaos_scenarios:
        if rand <= threshold:
            ...
            if isinstance(result, HTTPException):
                logger.warning(
                    f"Backend: Chaos endpoint returning {result.status_code}",
                    error_type="chaos",
                    service="backend-processor",
                ...
                logger.info(
                    "Backend: Chaos endpoint succeeded",
                    service="backend-processor",
                    event="chaos_success",
                )
                return result
...
async def simulate_cascade_error() -> Dict[str, Any]:
    ...
    logger.info(
        "Backend: Attempting cascade error test",
        service="backend-processor",
    ...
    try:
        ...
        logger.info(
            "Backend: Cascade error - demo-app succeeded unexpectedly",
            service="backend-processor",
        ...
        logger.error(
            "Backend: Cascade error - network failure",
        ...
        logger.warning(
            "Backend: Cascade error - demo-app returned error as expected",
