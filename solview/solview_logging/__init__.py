...
class LoggerWrapper:
    ...
    def _get_logger_with_mask(self, ignore_mask: Optional[bool]) -> Any:
        ...
        logger_instance = (
            self._logger.bind(ignore_mask=ignore_mask)
    ...
    def warning(
        self, message: Any, *args, ignore_mask: Optional[bool] = None, **kwargs
    ):
    ...
    def critical(
        ...
        return self._get_logger_with_mask(ignore_mask).critical(
            message, *args, **kwargs
        )
    ...
    def exception(
        ...
        return self._get_logger_with_mask(ignore_mask).exception(
            message, *args, **kwargs
        )
