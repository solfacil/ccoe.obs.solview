...
async def list_products(
    ...
    with tracer.start_as_current_span("api_list_products") as span:
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail="Internal server error while listing products"
            )
...
async def get_product(
    ...
    with tracer.start_as_current_span("api_get_product") as span:
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail="Internal server error while retrieving product"
            )
    ...
    with tracer.start_as_current_span("api_search_products") as span:
        ...
        try:
            ...
            response = ProductListResponse(
                ...
                limit=len(
                    product_responses
                ),  # Sem paginação na busca para simplicidade
                offset=0,
            )
            ...
            raise HTTPException(
                status_code=500, detail="Internal server error while searching products"
            )
