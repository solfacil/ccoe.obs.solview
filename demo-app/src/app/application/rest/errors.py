...
async def simulate_bad_request() -> Dict[str, Any]:
    ...
    logger.warning(
        "Simulating 400 Bad Request error",
...
async def simulate_unauthorized() -> Dict[str, Any]:
    ...
    logger.warning(
        "Simulating 401 Unauthorized error",
...
async def simulate_not_found() -> Dict[str, Any]:
    ...
    logger.warning(
        "Simulating 404 Not Found error",
...
async def simulate_validation_error() -> Dict[str, Any]:
    ...
    logger.warning(
        "Simulating 422 Validation error",
...
async def simulate_rate_limit() -> Dict[str, Any]:
    ...
    logger.warning(
        "Simulating 429 Rate Limit error",
...
async def simulate_bad_gateway() -> Dict[str, Any]:
    ...
    logger.error(
        "Simulating 502 Bad Gateway error",
...
async def simulate_service_unavailable() -> Dict[str, Any]:
    ...
    logger.error(
        "Simulating 503 Service Unavailable error",
...
async def simulate_gateway_timeout() -> Dict[str, Any]:
    ...
    logger.error(
        "Simulating 504 Gateway Timeout error",
...
async def simulate_random_error() -> Dict[str, Any]:
    ...
    logger.warning(
        f"Simulating random error: {status_code}",
    ...
    raise HTTPException(
        status_code=status_code, detail=f"{error_message} - Random error for testing"
    )
...
async def simulate_slow_endpoint() -> Dict[str, Any]:
    ...
    logger.info(
        f"Simulating slow endpoint with {delay:.2f}s delay",
        delay_seconds=delay,
    ...
    if random.random() < 0.2:
        logger.error(
            "Slow endpoint timed out", error_type="timeout", event="error_simulation"
        )
...
async def simulate_chaos() -> Dict[str, Any]:
    ...
    chaos_scenarios = [
        ...
        (
            0.5,
            lambda: HTTPException(status_code=503, detail="Chaos: Service Unavailable"),
        ),
    ...
    for threshold, action in chaos_scenarios:
        if rand <= threshold:
            ...
            if isinstance(result, HTTPException):
                logger.warning(
                    f"Chaos endpoint returning {result.status_code}",
                    error_type="chaos",
                ...
                logger.info("Chaos endpoint succeeded", event="chaos_success")
                return result
